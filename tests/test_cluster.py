...
*"""
        ...
        assert pc_res == """2
 0.0000    2.00000000    0.00000000    0.00000000
 0.0000    2.00000000    0.00000000    1.00000000
"""
    ...
    def test_recharged(self):
        ...
        assert recharged.charge == approx(4)
        ...
        recharged2 = cluster.recharged(3.9)
        assert recharged2 != recharged
        assert recharged2.charge == approx(3.9)
